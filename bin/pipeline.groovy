def DOCKER_NAME = "consumer-demo"
def IMAGE_NAME = "iotat/consumer-demo"
def GITHUB_URL = "https://github.com/iotat-software/spring-cloud-demo-consumer.git"
def PORT = "18081:18081"
pipeline {
    agent any
    stages {
        stage('停止正在运行的容器') {
